...
public var targetVector = Vector3.forward;

   function SetTargetPos(targetPos : Vector3)
   {
...
function SetEffect(_effect : float)
{
    effect = _effect;
}
...
function LateUpdate ()
{
    if (Time.deltaTime == 0)
   	...
   	target = targetTransform? targetTransform.position : targetVector;
