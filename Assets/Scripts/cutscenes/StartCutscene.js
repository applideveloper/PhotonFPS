...
class StartCutscene extends MonoBehaviour
{
	...
	function Update()
	{
		...
		var thirdPersonCameraActive: boolean;
		#if UNITY_3_5
			thirdPersonCameraActive = thirdPersonCamera.active;
		#endif
		#if UNITY_4
			thirdPersonCameraActive = thirdPersonCamera.activeSelf;
		#endif
        if(!loading && thirdPersonCameraActive)
        {
            if(sarge != null)
                {
